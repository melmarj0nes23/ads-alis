...
// .wrangler/tmp/bundle-3wcYjV/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-bFWigS/functionsWorker-0.7910895465433068.mjs
...
var formatViews = /* @__PURE__ */ __name2((viewCount) => {
  if (!viewCount)
    return "1.2M views";
...
var formatDuration = /* @__PURE__ */ __name2((val) => {
  if (!val)
    return "10:00";
...
async function searchYouTube(query) {
  ...
  const fetchWithTimeout = /* @__PURE__ */ __name2(async (url, timeoutMs) => {
  ...
  const fetchAndParse = /* @__PURE__ */ __name2(async (endpoint) => {
    try {
...
__name2(searchYouTube, "searchYouTube");
...
// .wrangler/tmp/bundle-3wcYjV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3wcYjV/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7910895465433068.js.map
